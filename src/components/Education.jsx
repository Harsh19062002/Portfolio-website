    ...
    >
      ...
      <div className="relative">
        ...
        {education.map((edu, index) => (
          ...
          >
            {/* Circle Logo on Timeline */}
            <div className="absolute sm:left-1/2 left-0 transform -translate-x-1/2 bg-white border-4 border-[#8245ec] w-16 h-16 rounded-full flex justify-center items-center z-10">
              <img
                src={edu.img}
                alt={edu.school}
